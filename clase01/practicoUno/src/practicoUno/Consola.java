...
public class Consola {
	...
	private static void ejercicioDos(Scanner sc) {
				...
				try {
					...
					try {
						...
						try {
							...
							activoLujo = ((r.equalsIgnoreCase("s"))||(r.equalsIgnoreCase("si")));
							
							//verifico que este bien escrita la respuesta
							if ((r.equalsIgnoreCase("n"))||(r.equalsIgnoreCase("no")) || activoLujo) flag = !flag;
		...
		System.out.print("\nDe acuerdo a la informacion recibida, usted ");
				
		if ((salario < salarioMax) && (vehiculos.compareTo(vehiculosMax) < 0 ) && (inmuebles.compareTo(inmueblesMax) < 0 ) && !activoLujo) {
			System.out.print("no");
		}
